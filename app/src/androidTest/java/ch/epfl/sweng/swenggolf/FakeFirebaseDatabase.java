...
public final class FakeFirebaseDatabase {
    ...
    private static final Offer[] offers = {
            new Offer("id_robin", "6-pack beers for ModStoch homework", LOREM, IMAGE, "1"),
            new Offer( "id_eric", "Chocolate for tractor", LOREM, IMAGE, "2"),
            new Offer("id_ugo", "ModStoch help for food", LOREM, IMAGE, "3"),
            new Offer( "id_elsa", "Pizzas for beer", LOREM, IMAGE, "4"),
            new Offer("id_seb", "Everything for a canton that doesn't suck and some "
                    + "more text to overflow the box", LOREM, IMAGE, "5"),
            new Offer("id_markus", "My kingdom for a working DB", LOREM, IMAGE, "6")};
